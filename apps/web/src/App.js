...
const router = createBrowserRouter([
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'settings/theme', element: _jsx(PermissionRoute, { permission: "treasury.manage", children: _jsx(ThemeGalleryPage, {}) }) },
            ...
            { path: 'vendor-accounts', element: _jsx(PermissionRoute, { anyOf: ['vendor_accounts.view', 'vendor_accounts.manage', 'inventory.manage'], children: _jsx(VendorAccountsPage, {}) }) },
