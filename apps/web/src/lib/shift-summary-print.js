...
import { formatShiftDuration, formatShiftMoney, formatShiftOpenedAt, shiftCollectionRows, } from './shift-summary-utils.js';
...
function wrapThermalDocument(body) {
...
function buildUncollectedSection(summary) {
...
export function buildShiftSummaryThermalHtml(params) {
...
export async function printShiftSummary(params) {
...
export function openShiftSummaryPreviewWindow(params) {
    const html = buildShiftSummaryThermalHtml(params);
