...
export function InventoryPage() {
    ...
    const fetchStockItems = async () => {
        if (!branchId)
            return;
        try {
            const r = await fetch(`${API_BASE}/stock-items?branchId=${branchId}`, { headers });
            if (r.ok)
    ...
    const fetchWarehouses = async () => {
        if (!branchId)
            return;
        try {
            const r = await fetch(`${API_BASE}/warehouses?branchId=${branchId}`, { headers });
            if (r.ok)
    ...
    const fetchProducts = async () => {
        if (!branchId)
            return;
        try {
            const r = await fetch(`${API_BASE}/products?branchId=${branchId}`, { headers });
            if (r.ok)
...
function PurchasingPanel({ branchId, warehouses, accessToken }) {
    ...
    return (_jsxs(Stack, { spacing: 2, children: [msg ? _jsx(Alert, { severity: "success", onClose: () => setMsg(''), children: msg }) : null, _jsxs(Stack, { direction: { xs: 'column', md: 'row' }, spacing: 1, children: [_jsx(TextField, { label: "\u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0631\u062F", size: "small", value: vendorName, onChange: (e) => setVendorName(e.target.value) }), _jsx(TextField, { label: "\u0627\u0644\u0643\u0648\u062F", size: "small", value: vendorCode, onChange: (e) => setVendorCode(e.target.value) }), _jsx(Button, { variant: "contained", onClick: createVendor, children: "\u0625\u0636\u0627\u0641\u0629 \u0645\u0648\u0631\u062F" })] }), _jsxs(Table, { size: "small", children: [_jsx(TableHead, { children: _jsxs(TableRow, { children: [_jsx(TableCell, { children: "\u0627\u0644\u0645\u0648\u0631\u062F" }), _jsx(TableCell, { children: "\u0627\u0644\u0643\u0648\u062F" }), _jsx(TableCell, { children: "\u0627\u0644\u0647\u0627\u062A\u0641" })] }) }), _jsx(TableBody, { children: vendors.map((v) => (_jsxs(TableRow, { children: [_jsx(TableCell, { children: v.name }), _jsx(TableCell, { children: v.code }), _jsx(TableCell, { children: v.phone ?? '—' })] }, v.id))) })] }), _jsx(Typography, { variant: "subtitle1", fontWeight: 800, children: "\u0623\u0648\u0627\u0645\u0631 \u0627\u0644\u0634\u0631\u0627\u0621" }), _jsxs(Table, { size: "small", children: [_jsx(TableHead, { children: _jsxs(TableRow, { children: [_jsx(TableCell, { children: "\u0631\u0642\u0645 \u0627\u0644\u0623\u0645\u0631" }), _jsx(TableCell, { children: "\u0627\u0644\u0645\u0648\u0631\u062F" }), _jsx(TableCell, { children: "\u0627\u0644\u062D\u0627\u0644\u0629" }), _jsx(TableCell, {})] }) }), _jsx(TableBody, { children: purchaseOrders.map((po) => (_jsxs(TableRow, { children: [_jsx(TableCell, { children: po.orderNumber }), _jsx(TableCell, { children: po.vendor?.name }), _jsx(TableCell, { children: _jsx(Chip, { size: "small", label: po.status }) }), _jsx(TableCell, { children: po.status !== 'RECEIVED' && po.status !== 'CANCELLED' ? (_jsx(Button, { size: "small", onClick: () => receivePO(po.id), children: "\u0627\u0633\u062A\u0644\u0627\u0645" })) : null })] }, po.id))) })] })] }));
}
