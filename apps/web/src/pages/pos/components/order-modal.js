...
export function OrderModal(props) {
    ...
    return (_jsxs(Dialog, { open: props.open, onClose: props.onClose, fullScreen: props.fullScreen, maxWidth: "xl", fullWidth: true, PaperProps: { sx: { borderRadius: props.fullScreen ? 0 : 4, bgcolor: '#faf6f1' } }, children: [_jsx(DialogTitle, { sx: { pb: 1, borderBottom: '1px solid rgba(117,89,77,0.12)', bgcolor: 'rgba(255,250,244,0.98)' }, children: _jsxs(Stack, { direction: "row", justifyContent: "space-between", alignItems: "center", gap: 1, children: [_jsxs(Box, { children: [_jsx(Typography, { variant: "h6", fontWeight: 800, children: isEdit
                            ...
                            if (!res?.ok && res?.error)
                                setValidationError(res.error);
                        }, children: "\u062A\u0639\u0644\u064A\u0642" })) : null, _jsx(Button, { variant: "contained", disabled: props.cartItems.length === 0, onClick: isEdit ? () => void handleSaveEdit() : handleCloseOrder, sx: { fontWeight: 800, px: 3 }, children: isEdit ? `حفظ التعديلات · ${formatCurrency(props.total)}` : `إغلاق وتأكيد · ${formatCurrency(props.total)}` }), !isEdit ? (_jsx(Button, { variant: "text", disabled: props.cartItems.length === 0, onClick: openReview, sx: { fontWeight: 700 }, children: "\u0645\u0631\u0627\u062C\u0639\u0629" })) : null] }), !isEdit ? (_jsx(OrderConfirmDialog, { open: confirmOpen, orderCode: props.currentOrderCode, orderType: props.orderType, orderOwnerName: props.orderOwnerName, customerPhone: props.customerPhone, customerAddress: props.customerAddress, captainName: props.captainName, cartItems: props.cartItems, paymentMethod: props.paymentMethod, paymentMethods: props.paymentMethods, collectionStatus: props.collectionStatus, discount: props.discount, subtotal: props.subtotal, total: props.total, orderNote: props.orderNote, onCancel: () => setConfirmOpen(false), onConfirm: handleCloseOrder })) : null] }));
}
