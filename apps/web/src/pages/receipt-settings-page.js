...
export function ReceiptSettingsPage() {
    ...
    const handleTestPrint = async () => {
        ...
        if (saved.printMode === 'escpos') {
            ...
            setPrintMsg(res.ok ? 'تمت طباعة الاختبار (ESC/POS — سريع).' : res.message);
            return;
        }
