...
export function TreasuryWorkspacePage() {
    ...
    return (_jsxs(Stack, { spacing: 2.5, children: [_jsxs(Paper, { elevation: 0, sx: { p: 2.5, borderRadius: 5, background: 'linear-gradient(135deg, #2f1f24, #5a2718)', color: '#fff7ed' }, children: [_jsx(Typography, { variant: "h5", fontWeight: 800, children: cashierView ? 'ورديتي المفتوحة' : 'الخزنة والورديات' }), _jsx(Typography, { variant: "body2", sx: { opacity: 0.85, mt: 0.5 }, children: cashierView
                            ...
                            if (next < fromDate)
                                setFromDate(next);
                        }, InputLabelProps: { shrink: true }, helperText: "\u0639\u0631\u0636 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0641\u062A\u0631\u0629 \u0627\u0644\u0645\u062D\u062F\u062F\u0629", sx: { minWidth: 160 } }), _jsxs(Stack, { direction: "row", spacing: 1, alignItems: "center", flexWrap: "wrap", useFlexGap: true, children: [_jsx(Button, { size: "small", variant: isTodayRange(fromDate, toDate) ? 'contained' : 'outlined', onClick: setTodayRange, children: "\u0627\u0644\u064A\u0648\u0645" }), _jsx(Chip, { size: "small", color: isTodayRange(fromDate, toDate) ? 'primary' : 'default', variant: isTodayRange(fromDate, toDate) ? 'filled' : 'outlined', label: formatDateRangeLabelAr(fromDate, toDate) }), isFetching ? _jsx(CircularProgress, { size: 18 }) : null] })] })), !cashierView ? (_jsx(Box, { sx: { borderBottom: 1, borderColor: 'divider' }, children: _jsx(Tabs, { value: safeTab, onChange: (_, v) => setTab(v), variant: "scrollable", scrollButtons: "auto", children: visibleTabs.map((t) => (_jsx(Tab, { label: t.label }, t.key))) }) })) : null, isLoading && !workspace ? (_jsx(Typography, { color: "text.secondary", children: "\u062C\u0627\u0631\u064A \u0627\u0644\u062A\u062D\u0645\u064A\u0644..." })) : workspace ? (_jsxs(_Fragment, { children: [activeTabKey === 'current' ? (_jsx(CurrentShiftTab, { workspace: workspace, branchId: branchId, cashBoxId: cashBoxId, onRefresh: onRefresh, onMessage: onMessage })) : null, activeTabKey === 'approvals' ? (_jsx(ApprovalsTab, { workspace: workspace, onRefresh: onRefresh, onMessage: onMessage })) : null, activeTabKey === 'treasury' ? (_jsx(TreasuryTab, { workspace: workspace, branchId: branchId, cashBoxId: cashBoxId, onRefresh: onRefresh, onMessage: onMessage })) : null, activeTabKey === 'history' ? (_jsx(ShiftHistoryTab, { workspace: workspace, fromDate: fromDate, toDate: toDate })) : null] })) : null] }));
}
