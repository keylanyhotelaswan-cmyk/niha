...
export function DashboardPage() {
    ...
    return (_jsxs(Stack, { spacing: 2.5, children: [_jsxs(Paper, { elevation: 0, sx: { p: { xs: 2.5, md: 3.5 }, borderRadius: 6, color: '#fff7ed', background: 'linear-gradient(135deg, rgba(47,31,24,0.98) 0%, rgba(90,39,20,0.98) 38%, rgba(185,56,23,1) 72%, rgba(217,119,6,0.96) 100%)', overflow: 'hidden', position: 'relative' }, children: [_jsx(Box, { sx: { position: 'absolute', inset: 0, background: 'radial-gradient(circle at 15% 20%, rgba(255,255,255,0.16), transparent 25%), radial-gradient(circle at 85% 25%, rgba(255,255,255,0.14), transparent 22%)' } }), _jsxs(Stack, { spacing: 2, sx: { position: 'relative' }, children: [_jsx(Chip, { label: "\u0644\u0648\u062D\u0629 \u062A\u0634\u063A\u064A\u0644 \u0645\u0637\u0639\u0645", sx: { alignSelf: 'flex-start', bgcolor: 'rgba(255,247,237,0.16)', color: '#fff7ed' } }), _jsx(Typography, { variant: "h3", fontWeight: 800, lineHeight: 1.2, children: "\u0645\u062A\u0627\u0628\u0639\u0629 \u062D\u064A\u0629 \u0644\u0644\u062A\u0634\u063A\u064A\u0644 \u0627\u0644\u064A\u0648\u0645\u064A: \u0628\u064A\u0639\u060C \u062E\u0632\u0646\u0629\u060C \u0645\u062E\u0632\u0648\u0646\u060C \u0648\u062A\u0623\u0633\u064A\u0633." }), _jsx(Typography, { variant: "h6", sx: { color: 'rgba(255,247,237,0.82)', maxWidth: 760, lineHeight: 1.9 }, children: "\u0627\u0644\u0623\u0631\u0642\u0627\u0645 \u0623\u062F\u0646\u0627\u0647 \u062A\u064F\u0642\u0631\u0623 \u0645\u0628\u0627\u0634\u0631\u0629 \u0645\u0646 \u0642\u0627\u0639\u062F\u0629 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0644\u064A\u0633 \u0645\u0646 \u0628\u064A\u0627\u0646\u0627\u062A \u062A\u062C\u0631\u064A\u0628\u064A\u0629." })] })] }), _jsx(Grid2, { container: true, spacing: 2, children: quickStats.map((stat) => (_jsx(Grid2, { size: { xs: 12, sm: 6, xl: 3 }, children: _jsx(MetricCard, { ...stat }) }, stat.label))) }), _jsxs(Grid2, { container: true, spacing: 2, children: [_jsx(Grid2, { size: { xs: 12, xl: 8 }, children: _jsx(SectionCard, { title: "\u0645\u0627\u0630\u0627 \u064A\u063A\u0637\u064A \u0627\u0644\u0646\u0638\u0627\u0645", description: "\u0648\u062D\u062F\u0627\u062A \u0623\u0633\u0627\u0633\u064A\u0629 \u0645\u062A\u0631\u0627\u0628\u0637\u0629 \u0644\u0643\u0646 \u0645\u0633\u062A\u0642\u0644\u0629 \u0645\u062D\u0627\u0633\u0628\u064A\u064B\u0627 \u0648\u062A\u0634\u063A\u064A\u0644\u064A\u064B\u0627.", children: _jsx(StatusCards, { items: modules }) }) }), _jsx(Grid2, { size: { xs: 12, xl: 4 }, children: _jsx(SectionCard, { title: "\u062F\u0648\u0631\u0629 \u0627\u0644\u0639\u0645\u0644 \u0627\u0644\u064A\u0648\u0645\u064A\u0629", description: "\u0645\u0644\u062E\u0635 \u0633\u0631\u064A\u0639 \u0644\u062A\u062A\u0627\u0628\u0639 \u0627\u0644\u062A\u0634\u063A\u064A\u0644 \u0627\u0644\u0645\u062A\u0648\u0642\u0639.", children: _jsx(WorkflowList, { items: workflowItems }) }) })] })] }));
}
